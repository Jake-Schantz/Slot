...
//        UIBarButtonItem.appearance(whenContainedInInstancesOf: UINavigationBar)
    ...
    func goToAuth() {
        let NavigationController = UIStoryboard(name: "Auth", bundle: nil).instantiateViewController(withIdentifier: "NavigationController") as? UINavigationController
        window?.rootViewController = NavigationController
        self.window?.makeKeyAndVisible()
    }
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "SLOT")
